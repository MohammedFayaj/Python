...
cost_20_server_day = 20 * cost_per_day
cost_20_server_month = 30*cost_20_server_day
cost_918_serve = 918 / cost_per_day
...
print('Cost to operate twenty servers per day is $ {}'.format(cost_20_server_day))
print('Cost to operate twenty servers per month is $ {}'.format(cost_20_server_month))
print('How many days can I operate one server with $918? {}'.format(cost_918_serve))
...
# Budgeting
budget = 918
operational_days = 918 / cost_per_day
# Display the results.
